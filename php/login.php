...
<head>
    ...
    <title>Tutor Login - Tuition Chai</title>
    ...
    <div class="header-bottom-area">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 mt-5 mb-10">
                <h4 class="text-center mb-3">Tutor Login</h4>
                            ...
                            <div class="email-login">
                                <form method="POST" action="login.php">
									...
									<div class="input-group mb-3">
                                        ...
                                        <input type="text" name="signinnumber" class="form-control " value="" placeholder="Phone Number">
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control " name="signinpassword" placeholder="Password" aria-label="password" aria-describedby="basic-addon2">
                                    </div>
									<div class="form-row">
                                        <div class="col-md-12">
